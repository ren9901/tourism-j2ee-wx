<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="itemsList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="项目介绍" align="center" prop="itemDesc" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="项目介绍" prop="itemDesc">
...
<script>
import { listItems, getItems, delItems, addItems, updateItems } from "@/api/abuwx/items";
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除推荐项目管理编号为"' + ids + '"的数据项？').then(function() {
        return delItems(ids);
      }).then(() => {
        this.getList();
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('abuwx/items/export', {
        ...this.queryParams
